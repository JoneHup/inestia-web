...
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (11, '横琴先进智能计算平台的产品', '推理计算型', NULL, NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (12, '横琴先进智能计算平台的产品', '训练计算型', NULL, NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (13, '横琴先进智能计算平台的产品', 'CPU通用计算型', NULL, NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (21, '寒武纪的部分产品及技术', '系列1', '思元100', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (22, '寒武纪的部分产品及技术', '系列1', '思元270', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (23, '寒武纪的部分产品及技术', '系列1', '全国产', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (24, '寒武纪的部分产品及技术', '系列2', '产品1', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (25, '寒武纪的部分产品及技术', '系列2', '产品2', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (31, '产品的各项实际应用', '智慧城市', '城市实时仿真', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (32, '产品的各项实际应用', '智慧城市', '智能交通系统', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (33, '产品的各项实际应用', '智慧产业', '智能教育', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (34, '产品的各项实际应用', '智慧产业', '智能物流', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (35, '产品的各项实际应用', '智慧产业', '智能医疗', NULL, 0);
INSERT INTO `sys_product`(`id`, `root_name`, `parent_name`, `node_name`, `url`, `dr`) VALUES (36, '产品的各项实际应用', '智慧产业', '智能医疗', NULL, 0);
